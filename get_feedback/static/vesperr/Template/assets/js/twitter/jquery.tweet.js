(function($) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      template: "{avatar}{time}{text}{join}",   // [string or function] template used to construct each tweet <li> - see code for available vars
      ...
      $(widget).bind("load", function(){
        $.getJSON(build_url(), function(data){
          ...
          var tweets = $.map(data.results || data, function(item){
			...
			var time = '<span class="tweet_time"><a href="'+tweet_url+'" title="view tweet on twitter"><i class="icon-128 icon-twitter"></i></a></span><br />';
